...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('Lambda', default_value= "1.", description="Proportional value"),
        DeclareLaunchArgument('Lambda_zf', default_value= "60.0", description="Proportional value for robot steps"),
        ...
        DeclareLaunchArgument('sceneDepth', default_value= "0.22", description="Depth of the scene"),
        ...
        # DeclareLaunchArgument('dtX', default_value= "0.122", description="Relative initial position"),
        # DeclareLaunchArgument('dtY', default_value= "0.091", description="Relative initial position"),
        # DeclareLaunchArgument('dtZ', default_value= "0.01", description="Relative initial position"),
        # DeclareLaunchArgument('drX', default_value= "40.0", description="Relative initial position"),
        # DeclareLaunchArgument('drY', default_value= "0.0", description="Relative initial position"),
        # DeclareLaunchArgument('drZ', default_value= "-45.0", description="Relative initial position"),

        # DeclareLaunchArgument('dtX', default_value= "-0.076", description="Relative initial position"),
        ...
        DeclareLaunchArgument('dtY', default_value= "0.43", description="Relative initial position"),
        ...
        # DeclareLaunchArgument('dtX', default_value= "0.07", description="Relative initial position"),
        # DeclareLaunchArgument('dtY', default_value= "0.13", description="Relative initial position"),
        # DeclareLaunchArgument('dtZ', default_value= "0.30", description="Relative initial position"),
        # DeclareLaunchArgument('drX', default_value= "-12.0", description="Relative initial position"),
        # DeclareLaunchArgument('drY', default_value= "10.0", description="Relative initial position"),
        # DeclareLaunchArgument('drZ', default_value= "20.0", description="Relative initial position"),
        Node(
        ...
        TimerAction(
            ...
            Node(
                ...
                namespace="",
                executable="ros2_dvs_bridge_focusControlDirectVisualservoing",
                name="focusControlVisualServoing",
                remappings=[('image', 'Camera/Image'),
                ...
                parameters=[{'Image_topic': LaunchConfiguration('Image_topic'),
                            ...
                            'Lambda_zf': LaunchConfiguration('Lambda_zf'),
